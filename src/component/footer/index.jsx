                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li><Link to="/" className="text-gray-500 hover:text-green-600 text-sm transition-colors">Anasayfa</Link></li>
                                <li><Link to="/hizmetlerimiz" className="text-gray-500 hover:text-green-600 text-sm transition-colors">Hizmetlerimiz</Link></li>
                                <li><Link to="/blog" className="text-gray-500 hover:text-green-600 text-sm transition-colors">Blog</Link></li>
                                <li><Link to="/iletisim" className="text-gray-500 hover:text-green-600 text-sm transition-colors">İletişim</Link></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li><Link to="/hurda-demir-fiyatlari" className="text-gray-500 hover:text-green-600 text-sm transition-colors">Demir Fiyatları</Link></li>
                                <li><Link to="/hurda-bakir-fiyatlari" className="text-gray-500 hover:text-green-600 text-sm transition-colors">Bakır Fiyatları</Link></li>
                                <li><Link to="/hurda-aluminyum-fiyatlari" className="text-gray-500 hover:text-green-600 text-sm transition-colors">Alüminyum Fiyatları</Link></li>
                            </ul>
                        </div>
