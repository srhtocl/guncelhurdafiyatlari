            ...
            <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-md overflow-hidden p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                        ...
                        <p className="text-gray-600 mb-4">Hurda fiyatlarını güncelleyin ve yönetin.</p>
                        <button onClick={() => navigate('/admin/prices')} className="text-blue-500 hover:text-blue-700 font-medium">Yönet &rarr;</button>
                    </div>
                    ...
                    <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                        ...
                        <button onClick={() => navigate('/admin/blog')} className="text-blue-500 hover:text-blue-700 font-medium">Yönet &rarr;</button>
                    </div>
                    ...
                    <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                        ...
                        <button onClick={() => navigate('/admin/messages')} className="text-blue-500 hover:text-blue-700 font-medium">Mesajları Gör &rarr;</button>
                    </div>
                </div>
            </div>
        </div>
