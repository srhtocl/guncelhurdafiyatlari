        ...
        <header className="bg-white shadow-sm border-b border-gray-50 sticky top-0 z-[100] backdrop-blur-sm bg-white/90">
            <div className="container mx-auto px-4 py-3 flex justify-between items-center">
                ...
                <nav className="hidden md:flex items-center gap-8">
                    <Link href="/" className="font-medium text-gray-500 hover:text-green-600 transition-colors">
                        Anasayfa
                    </Link>
                    ...
                    <Link href="/hizmetlerimiz" className="font-medium text-gray-500 hover:text-green-600 transition-colors">
                        Hizmetlerimiz
                    </Link>
                    <Link href="/blog" className="font-medium text-gray-500 hover:text-green-600 transition-colors">
                        Blog
                    </Link>
                    <Link href="/iletisim" className="font-medium text-gray-500 hover:text-green-600 transition-colors">
                        Bize Ulaşın
                    </Link>
